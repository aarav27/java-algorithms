...
public class CircularLinkedList<T> {
    ...
    //7. Implement an algorithm to find whether a linked list is a circular or has loop :: Given head node
    ...
    //8. Implement an algorithm to get node at the beginning of the loop of a circular linked list :: Given head node
    ...
    //9. Implement an algorithm to detected whether a linked list is a circular or has loop; and further remove the loop :: Given head node
